...
**The throughline.** Read end to end, the timeline attributes essentially every failure to a departed former franchisee, casts the current owners as unwitting inheritors, and frames corporate as the diligent party that "finally" assembled the truth, all while sourcing its most important claims to itself, contradicting the documented record on the stickers, contradicting its own companion post on at least three dates and names, and never accounting for what happened to the collection once corporate controlled the store. The stated reason for the separation is the social-media campaign. The conduct that prompted the campaign goes undescribed.
